...
export const experience = [
    {
        ...
        details: ["Developed portals for medicines accounting for leading international healthcare companies as a full-stack developer;", 
                  "Developed server tools for a healthcare company;"],
        tags: ["TypeScript", "Vue.js", "Bootstrap", ".NET Core MVC", ".NET6", "MSSQL", "Razor"],
        icon: "truck ",
    },
    {
        title: "U - Tek",
        ...
        details: ["Wrote corporate WPF and Windows Forms applications in C#;",
        ...
        tags: ["GStreamer", "GTK3.0", "RESTApi", "EF5/6", "ADO .NET", "SyngThing", ".NET Framework", ".NET Core", "WPF", "Windows Forms", "MSSQL", "SQLight", "Video/Audio Broadcasting"],
        icon: "heartbeat ",
    },
    {
        title: "Viburn Ltd",
        ...
        subtitle: ".NET Developer",
        details: ["Developed the financial product for a UK fintech company as a back-end developer;",
        ...
        tags: ["WPF", "WCF", "ADO .NET", ".NET Framework", "Windows Forms", "MSSQL"],
        icon: "qrcode ",
    },
    {
        title: "H2O Ltd",
        ...
        details: ["Development of embedded devices, and firmware for AVR and STM32 microcontrollers;",
        ...
        tags: ["WPF", "Firmware", "C#", "Embedded C", "Windows Forms", "PLC Programming", "SCADA"],
        icon: "qrcode ",
    },
    {
        title: "Microtronic",
        ...
        subtitle: "Electronic Engineer",
        details: ["Modeled and developed electronic devices and ship automation modules;",
                  "Created software for PLC;"],
        tags: ["Hardware Development", "Firmware", "Microcontrollers", "Embedded C", "P-CAD", "OrCAD", "SCADA"],
        icon: "qrcode ",
    },
    {
        title: "Fiolent",
        ...
        details: ["Modeled and developed electronic devices and ship automation modules;",
                  "Created software for PLC;"],
        tags: ["Hardware Development", "Firmware", "Microcontrollers", "Embedded C", "P-CAD", "OrCAD", "Circuit Design"],
        icon: "group ",
    },
];
